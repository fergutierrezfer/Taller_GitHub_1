...
COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.id_registro IS
'Identificador del registro';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.id_registro IS 'IDREG';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.id_registro TEXT IS
'Identificador del registro';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.descripcion IS
'Descripcion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.descripcion IS 'DESC';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.descripcion TEXT IS
'Descripcion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.usuario_creacion IS 'Usuario
creacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.usuario_creacion IS 'USCRE';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.usuario_creacion TEXT IS
'Usuario creacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.usuario_actualizacion IS
'Usuario actualizacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.usuario_actualizacion IS
'USACT';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.usuario_actualizacion TEXT IS
'Usuario actualizacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.version_registro IS
'Version';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.version_registro IS 'VRSRG';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.version_registro TEXT IS
'Version';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.observaciones IS
'Observaciones';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.observaciones IS 'OBSRV';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.observaciones TEXT IS
'Observaciones';
...
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.estado_registro TEXT IS
'Estado';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.created_at IS 'Fecha
creacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.created_at IS 'CRTM';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.created_at TEXT IS 'Fecha
creacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.updated_at IS 'Fecha
actualizacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.updated_at IS 'UPDTM';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Proveedores.updated_at TEXT IS 'Fecha
actualizacion';
