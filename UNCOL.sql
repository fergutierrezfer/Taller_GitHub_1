...
COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.id_registro IS
'Identificador del registro';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.id_registro IS 'IDREG';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.id_registro TEXT IS
'Identificador del registro';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.descripcion IS
'Descripcion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.descripcion IS 'DESC';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.descripcion TEXT IS
'Descripcion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.usuario_creacion IS 'Usuario
creacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.usuario_creacion IS 'USCRE';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.usuario_creacion TEXT IS
'Usuario creacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.usuario_actualizacion IS
'Usuario actualizacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.usuario_actualizacion IS
'USACT';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.usuario_actualizacion TEXT IS
'Usuario actualizacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.version_registro IS
'Version';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.version_registro IS 'VRSRG';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.version_registro TEXT IS
'Version';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.observaciones IS
'Observaciones';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.observaciones IS 'OBSRV';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.observaciones TEXT IS
'Observaciones';
...
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.estado_registro TEXT IS
'Estado';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.created_at IS 'Fecha
creacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.created_at IS 'CRTM';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.created_at TEXT IS 'Fecha
creacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.updated_at IS 'Fecha
actualizacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.updated_at IS 'UPDTM';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Retenciones.updated_at TEXT IS 'Fecha
actualizacion';
