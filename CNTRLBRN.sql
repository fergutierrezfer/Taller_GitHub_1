...
CREATE OR REPLACE TABLE FGUTIERRM1.Archivo_de_Sucursales FOR
SYSTEM NAME CNTRLBRN
(
...
COMMENT ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.id_registro IS 'Identificador
del registro';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.id_registro IS 'IDREG';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.id_registro TEXT IS
...
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.descripcion TEXT IS
'Descripcion';

COMMENT ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.usuario_creacion IS 'Usuario
creacion';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.usuario_creacion IS 'USCRE';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.usuario_creacion TEXT IS
'Usuario creacion';

COMMENT ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.usuario_actualizacion IS
'Usuario actualizacion';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.usuario_actualizacion IS
'USACT';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.usuario_actualizacion TEXT IS
'Usuario actualizacion';

COMMENT ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.version_registro IS
'Version';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.version_registro IS 'VRSRG';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.version_registro TEXT IS
'Version';

COMMENT ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.observaciones IS
'Observaciones';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.observaciones IS 'OBSRV';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.observaciones TEXT IS
'Observaciones';
...
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.estado_registro TEXT IS
'Estado';

COMMENT ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.created_at IS 'Fecha
creacion';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.created_at IS 'CRTM';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.created_at TEXT IS 'Fecha
creacion';

COMMENT ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.updated_at IS 'Fecha
actualizacion';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.updated_at IS 'UPDTM';
LABEL ON COLUMN FGUTIERRM1.Archivo_de_Sucursales.updated_at TEXT IS 'Fecha
actualizacion';
