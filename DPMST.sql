...
-- Descripción: Cabecera Declaracion Patrimonial Personas Naturales
-- Objetivo: Gestion de Cabecera Declaracion Patrimonial Personas Naturales
...
(
    ...
    CONSTRAINT PK_DPMST PRIMARY KEY (id_registro)
)
RCDFMT DPMSTREC;
