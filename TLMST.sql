...
COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.id_registro IS 'Identificador
del registro';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.id_registro IS 'IDREG';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.id_registro TEXT IS 'Identificador
del registro';
...
COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.usuario_creacion IS 'Usuario
creacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.usuario_creacion IS 'USCRE';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.usuario_creacion TEXT IS 'Usuario
creacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.usuario_actualizacion IS
'Usuario actualizacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.usuario_actualizacion IS 'USACT';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.usuario_actualizacion TEXT IS
'Usuario actualizacion';
...
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.version_registro TEXT IS
'Version';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.observaciones IS
'Observaciones';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.observaciones IS 'OBSRV';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.observaciones TEXT IS
'Observaciones';
...
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.created_at TEXT IS 'Fecha
creacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.updated_at IS 'Fecha
actualizacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.updated_at IS 'UPDTM';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Cajeros.updated_at TEXT IS 'Fecha
actualizacion';
