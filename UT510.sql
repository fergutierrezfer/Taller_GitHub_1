...
-- Objetivo: Gestion de Mensajes de Usuarios
...
CREATE OR REPLACE TABLE FGUTIERRM1.Mensajes_de_Usuarios FOR SYSTEM NAME UT510
(
    ...
    CONSTRAINT PK_UT510 PRIMARY KEY (id_registro)
)
RCDFMT UT510REC;

COMMENT ON TABLE FGUTIERRM1.Mensajes_de_Usuarios IS 'Mensajes de Usuarios';
