...
COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.id_registro IS 'Identificador del registro';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.id_registro IS 'IDREG';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.id_registro TEXT IS 'Identificador del registro';
...
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.descripcion TEXT IS 'Descripcion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.usuario_creacion IS 'Usuario creacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.usuario_creacion IS 'USCRE';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.usuario_creacion TEXT IS 'Usuario creacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.usuario_actualizacion IS 'Usuario actualizacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.usuario_actualizacion IS 'USACT';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.usuario_actualizacion TEXT IS 'Usuario actualizacion';
...
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.version_registro TEXT IS 'Version';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.observaciones IS 'Observaciones';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.observaciones IS 'OBSRV';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.observaciones TEXT IS 'Observaciones';
...
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.estado_registro TEXT IS 'Estado';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.created_at IS 'Fecha creacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.created_at IS 'CRTM';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.created_at TEXT IS 'Fecha creacion';

COMMENT ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.updated_at IS 'Fecha actualizacion';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.updated_at IS 'UPDTM';
LABEL ON COLUMN FGUTIERRM1.Maestro_de_Chequeras.updated_at TEXT IS 'Fecha actualizacion';
