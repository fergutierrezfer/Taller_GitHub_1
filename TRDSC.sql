...
-- Descripción: Descripciones Adicionales a las Transacciones
-- Objetivo: Gestion de Descripciones Adicionales a las Transacciones
...
(
    ...
    CONSTRAINT PK_TRDSC PRIMARY KEY (id_registro)
)
RCDFMT TRDSCREC;
