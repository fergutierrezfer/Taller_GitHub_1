...
-- Descripción: Tabla de Cargos por Servicios Tarifas Cobranzas
-- Objetivo: Gestion de Tabla de Cargos por Servicios Tarifas Cobranzas
...
(
    ...
    CONSTRAINT PK_CNTRLRCO PRIMARY KEY (id_registro)
)
RCDFMT CNTRLRCOREC;
