...
-- Descripción: Transacciones Historicas de Pagos y Recibos
-- Objetivo: Gestion de Transacciones Historicas de Pagos y Recibos
...
(
    ...
    CONSTRAINT PK_FIWRT PRIMARY KEY (id_registro)
)
RCDFMT FIWRTREC;
