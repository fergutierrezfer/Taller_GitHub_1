...
COMMENT ON COLUMN FGUTIERRM1.Agenda_Personalizada.id_registro IS 'Identificador del registro';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.id_registro IS 'IDREG';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.id_registro TEXT IS 'Identificador del registro';
...
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.descripcion TEXT IS 'Descripcion';

COMMENT ON COLUMN FGUTIERRM1.Agenda_Personalizada.usuario_creacion IS 'Usuario creacion';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.usuario_creacion IS 'USCRE';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.usuario_creacion TEXT IS 'Usuario creacion';

COMMENT ON COLUMN FGUTIERRM1.Agenda_Personalizada.usuario_actualizacion IS 'Usuario actualizacion';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.usuario_actualizacion IS 'USACT';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.usuario_actualizacion TEXT IS 'Usuario actualizacion';
...
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.version_registro TEXT IS 'Version';

COMMENT ON COLUMN FGUTIERRM1.Agenda_Personalizada.observaciones IS 'Observaciones';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.observaciones IS 'OBSRV';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.observaciones TEXT IS 'Observaciones';
...
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.estado_registro TEXT IS 'Estado';

COMMENT ON COLUMN FGUTIERRM1.Agenda_Personalizada.created_at IS 'Fecha creacion';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.created_at IS 'CRTM';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.created_at TEXT IS 'Fecha creacion';

COMMENT ON COLUMN FGUTIERRM1.Agenda_Personalizada.updated_at IS 'Fecha actualizacion';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.updated_at IS 'UPDTM';
LABEL ON COLUMN FGUTIERRM1.Agenda_Personalizada.updated_at TEXT IS 'Fecha actualizacion';
